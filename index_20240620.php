...
<body>
    ...
    <table class="Menu_Top" style="background:rgba(255,255,255,0.2);padding:8px;border-radius:5px;">
        <tr>
            <td><a href="http://namdinh.mailinhonline.vn" target="_blank">MLO<span></span></a></td>
            <td style="background:white;"></td>
			<td><a href="http://taxi2.congnghesotoancau.com.vn" target="_blank">GPS - ĐỊNH VỊ XE<span></span></a></td>
			<td style="background:white;"></td>
			<td><a href="javascript:void(0);" onclick="$('.NoiDung_Div').hide();$('#GiaTour_Div').toggle();">GIÁ ĐI TOUR<span></span></a></td>
			<td style="background:white;"></td>
			<td><a href="../danhba/" target="_blank">DANH BẠ ĐT<span></span></a></td>
			<td style="background:white;"></td>
			<td><a href="../" target="_blank">KH GỌI XE...<span></span></a></td>
			<td style="background:white;"></td>
			</td><td><a href="https://qlpt.pvcgo.net" target="_blank">QLPT<span></span></a></td>  
			<td style="background:white;"></td>
			<td>
			    <span style="position:relative;">
			        <a href="#" onclick="$('#Menu_QC31_DroptDown').toggle();">KSOÁT QC31</font><span></span></a>
			        <div id="Menu_QC31_DroptDown" style="color:green;display:none;position:absolute;top:40px;left:0px;background:white;border-radius:5px;border:1px solid green;padding:10px;z-index:120;width:150px;">
			            <table>
			                <tr>
			                    <td>
			                        <a onclick="$('#Menu_QC31_DroptDown').hide();" href="http://apps.mailinh.vn/ops/" target="_blank"><font color="green">GHI NHẬN QC31</font><span></span></a>
			                    </td>
			                </tr>
			                <tr>
			                    <td>
			                        <a onclick="$('#Menu_QC31_DroptDown').hide();" href="https://docs.google.com/spreadsheets/d/128ep0mDwnkoq5rAvJ3mvcLEf7EraPEAg/edit#gid=834284388" target="_blank"><font color="green">TỔNG HỢP QC31</font><span></span></a>
			                    </td>
			                </tr>
			                <tr>
			                    <td>
			                        <a href="#"><font color="green" onclick="$('.NoiDung_Div').hide();$('#QuyDinhTocDo_Div').show();$('#Menu_QC31_DroptDown').hide();$('#BangGia_Caption').hide();">Quy định tốc độ</font><span></span></a>
			                    </td>
			                </tr>
			            </table>
			        </div>
			...
			<td>
			    <span style="position:relative;">
			        <a href="#" onclick="$('#Menu_Khac_DroptDown').toggle();">KHÁC</font><span></span></a>
			        <div id="Menu_Khac_DroptDown" style="color:green;display:none;position:absolute;top:40px;left:0px;background:white;border-radius:5px;border:1px solid green;padding:10px;z-index:120;width:150px;">
			            <table>
			                <tr>
			                    <td style="text-align:left;margin-top:18px;">
			                        <a onclick="$('#Menu_Khac_DroptDown').hide();" href="https://mlnd.pvcgo.net/hanhchinh/electric/xulysucodien.php" target="_blank"><font color="green">* Ngắt điện khi bị sự cố</font><span></span></a>
			                    </td>
			                </tr>
        ...
        <tr>
            <td style="border-top:1px dotted white;padding:5px;"><a href="../thanhtoan/" target="_blank">CÁC HÌNH THỨC TT<span></span></a></td>
            <td style="background:white;"></td>
            
			<td style="border-top:1px dotted white;padding:5px;"><a href="../cskh/" target="_blank">CHĂM SÓC KH<span></span></a></td>
			<td style="background:white;"></td>
			<td style="border-top:1px dotted white;padding:5px;">
			    <a href="https://mailinh.vn/tin-tuc/huong-dan-xuat-hoa-don-dien-tu-taxi-mai-linh-1060.html?fbclid=IwAR013itjUEUpYLBUd0NZgMOwNdrW7LP4JPIBKZtpenk5ipwQNbqQVpnwzTE" target="_blank">HD xuất HĐơn<span></span></a>
			</td>
        </tr>
        
    </table>
    <div style="position:fixed;top:8px;right:8px;">
        <a href="https://mlnd.pvcgo.net/"><img src="tongdaitaxi1055.svg" height="30px"></a>
    </div>
<center>


<span id="BangGia_Caption"><h2> <font color="white">BẢNG TÍNH GIÁ CƯỚC</font></h2></span>
...
<div style="position:fixed;z-index:10;top:100px;left:0px;width:100%;">
    ...
    <div id="BangGia_Div" class="NoiDung_Div" style="max-width:850px;">
        <div style="float:left;max-width:400px;border-radius:5px;padding:0px;margin-top:15px;background:white;border:0.1px solid white;margin-right:20px;">
            <center>
                ...
                <div style="margin:20px;display:none;"><center>
                    <table class="BangGia_Table" style="width:100%;border-collapse: collapse;" >
                        ...
                        <tr>
                            ...
                            <td>
                               20.000<span style="font-size:12px;">đ/1.4km</span>
                            </td>
                            <td>
                                12.800
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                20.000<span style="font-size:12px;">đ/1.3km</span>
                            </td>
                            <td>
                                14.600
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                20.000<span style="font-size:12px;">đ/1.2km</span>
                            </td>
                            <td>
                                16.200
                            </td>
        ...
        <div id="GiaTour_Div"  class="NoiDung_Div" style="max-width:500px;border-radius:5px;padding:0px;margin-top:15px;background:white;border:0.05px solid rgba(255,255,255,0.1);margin-right:20px;display:none;position:relative;">
            <a href="#" style="text-decoration:none;"><div style="position:absolute;top:0px;right:2px;color:rgba(0,0,0,0.5);padding:5px;" onclick="$('.NoiDung_Div').hide();$('#BangGia_Div').show();">x</div></a>
            <center>
                <style>
                    .BangGia_Table {border:1px solid green;}
                    .BangGia_Table td {border:0.5px solid green;text-align:center;} 
                </style>
                <div style="margin:20px;"><center>
                    <table class="BangGia_Table" style="width:100%;border-collapse: collapse;" >
                        <tr style="background:green;color:white;font-size:14px;">
                            <td style="border:1px green solid;padding:8px;">
                                DÒNG XE
                            </td>
                            <td style="border:1px green solid;padding:8px;">
                                QUẤT LÂM (≤86km)
        ...
        <div id="QuyDinhTocDo_Div"  class="NoiDung_Div" style="width:800px;border-radius:5px;padding:0px;margin-top:0px;background:white;border:0.05px solid rgba(255,255,255,0.1);margin-right:20px;display:none;position:relative;">
            <a href="#" style="text-decoration:none;"><div style="position:absolute;top:0px;right:2px;color:rgba(0,0,0,0.5);padding:5px;" onclick="$('.NoiDung_Div').hide();$('#BangGia_Div').show();$('#BangGia_Caption').show();">x</div></a>
            <center>
                <div style="margin:5px;"><center>
                    <img src="toc do.jpg" style="width:100%;">
            	</div>
            </center>
        </div>
</center>
...
<div style="width:100%;background: -webkit-linear-gradient(top left, #45ac5e, #78b75c);border-radius:5px;color:white;position:fixed;bottom:0px;left:-1px;z-index:5;">
    <div style="height:8px;">.</div>
    CÔNG TY TRÁCH NHIỆM HỮU HẠN MAI LINH NAM ĐỊNH<span style="float:right;margin-right:5px;"><?php include ($_SERVER['DOCUMENT_ROOT'].'/counters/count_giacuoc.php'); ?></span>
